...
class ClientDiscover:
    def __init__(self, connection, disc_type, parent, *args):
...
class ClientService:
    ...
    def characteristics(self, uuid=None):
        return ClientDiscover(self.connection, ClientCharacteristic, self, uuid)
...
class ClientCharacteristic(BaseClientCharacteristic):
    ...
    def descriptors(self):
        return ClientDiscover(self.connection, ClientDescriptor, self)
